...
var dataApplesToApples = ['Apples to Apples', 4, 10, 12, 'false', 30, 6,
  'description text additions to text the css that i am creating because it needs to be here. This is a big blurb of texty text so we can make this look normal.'];
var dataBalderdash = ['Balderdash', 2, 6, 12, 'true', 30, 6, 'The party game Apples to Apples consists of two decks of cards: Things and Descriptions. Each round, the active player draws a Description card  from the deck, then the other players each secretly choose the Thing card in hand that best matches that description and plays it face-down on the table. Once a player has won a pre-determined number of Description cards, that player wins.'];
