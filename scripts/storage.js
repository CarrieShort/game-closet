...
var dataApplesToApples = ['Apples to Apples', 4, 10, 12, 'false', 30, 6,
...
var dataBalderdash = ['Balderdash', 2, 6, 12, 'true', 30, 6,
...
var dataBattleship = ['Battleship', 2, 2, 8, 'true', 30, 4.5,
...
var dataCandyland = ['Candyland', 2, 2, 4, 'false', 30, 3,
  'Players take turns removing the top card from a stack.The deck has one card for each named location, and drawing such a card moves a player directly to that board location. The game is won by landing on or passing the final square and thus reaching the goal of the Candy Castle.'
];
var dataCardsAgainstHumanity = ['Cards Against Humanity', 4, 30, 17, 'true', 30,
  6.5,
  'Very similar to the popular and fairly inoffensive Apples to Apples. While the games are similar, the sense of humor required is very different. The game encourages players to poke fun at practically every awkward or taboo subject.'
];
var dataCheckers = ['Checkers', 2, 2, 6, 'false', 30, 5,
...
var dataChess = ['Chess', 2, 2, 6, 'false', 60, 7,
  'Chess is a two-player, abstract strategy board game that represents medieval warfare on an 8x8 board with alternating light and dark squares. Players take turns moving one of their pieces in an attempt to capture, attack, defend, or develop their positions.'
];
var dataClue = ['Clue', 3, 6, 8, 'false', 60, 5,
  'The classic detective game! In Clue, players move from room to room in a mansion to solve the mystery of: who done it, with what, and where? A great game for those who enjoy reasoning and thinking things out.'
];
var dataCranium = ['Cranium', 4, 16, 13, 'false', 60, 5.5,
  'Cranium bills itself as the "whole-brain" game. It\'s a party game that borrows from a host of other popular party games of recent times.'
];
var dataDominion = ['Dominion', 2, 4, 12, 'false', 30, 8.5,
  'In Dominion, each player starts with an identical, very small deck of cards. In the center of the table is a selection of other cards the players can "buy" as they can afford them. Through their selection of cards to buy, and how they play their hands as they draw them, the players construct their deck on the fly, striving for the most efficient path to the precious victory points by game end.'
];
var dataDontWakeDaddy = ['Don\'t Wake Daddy', 2, 4, 3, 'false', 30, 4,
...
var dataHungryHungryHippos = ['Hungry Hungry Hippos', 2, 4, 4, 'true', 30, 4,
...
var dataJenga = ['Jenga', 1, 8, 6, 'true', 30, 5,
...
var dataLife = ['Life', 2, 6, 8, 'false', 60, 4,
...
var dataLoadedQuestions = ['Loaded Questions', 3, 6, 13, 'true', 60, 6,
  'Hilarious board game that tests players on how well they know each other with over 500 fun personality-filled questions.'
];
var dataMancala = ['Mancala', 2, 2, 5, 'false', 30, 6,
  'This entry is referencing only the popular game also known as Kalah, invented in the mid 20th century in America. The game ends when one player no longer has any seeds in any of his holes. The remaining pieces are captured by his adversary. The player who has captured most pieces is declared the winner.'
];
var dataMonopoly = ['Monopoly', 2, 8, 8, 'false', 180, 4.5,
...
var dataMouseTrap = ['Mouse Trap', 2, 4, 6, 'true', 30, 4,
  'Mouse Trap pits players against each other as mice trying to navigate through a complex mousetrap. They build the Rube Goldberg inspired mousetrap as they move their mice across the board. If the mousetrap doesn\'t malfunction, the mouse is captured and out of the game. The winner is the last mouse who avoids being trapped.'
];
var dataPictionary = ['Pictionary', 3, 16, 12, 'true', 90, 6,
...
var dataSettlersofCatan = ['Settlers of Catan', 2, 4, 7, 'false', 60, 7,
  'This game uses the familiar Catan hex-tile grid to present a map of the United States. Players collect and trade resources in order to purchase, migrate and build settlements, forge railroads, and acquire locomotives.'
];
var dataChutesandLadders = ['Chutes and Ladders', 2, 4, 4, 'true', 30, 5,
  'Classic game challenges you to scramble to the top of the game board without slip-sliding down!'
];
var dataSorry = ['Sorry', 2, 4, 6, 'true', 30, 4.5,
...
var dataTaboo = ['Taboo', 4, 10, 12, 'true', 30, 6,
  'Taboo is a party word game. Players take turns describing a word or phrase on a drawn card to their partner without using five common additional words or phrases also on the card.'
];
var dataTwister = ['Twister', 2, 4, 6, 'true', 30, 4.5,
...
var dataTrivialPursuit = ['Trivial Pursuit', 2, 24, 12, 'false', 90, 5,
  'The goal of the game is to collect a pie in each color. The colors correspond to different question categories. Once the player has one pie in each color, she can move along the spokes to the middle of the board to win the game.'
];
var dataTrouble = ['Trouble', 2, 4, 4, 'true', 60, 3.5,
  'The game is abstract, each player has set of pawns of his color. Each turn player rolls a die using the Pop-O-Matic and selects one of his pawns to move.'
];
var dataUno = ['Uno', 2, 10, 6, 'true', 30, 5,
...
var dataYahtzee = ['Yahtzee', 2, 10, 6, 'true', 30, 5,
  'Each player tries to fill in a score for each category, but this is not always possible. When all players have entered a score or a zero for all 13 categories, the game ends and total scores are compared.'
];
var dataScrabble = ['Scrabble', 2, 4, 10, 'false', 90, 6.3,
